...
public class FormCuenta extends Activity implements View.OnClickListener {
    ImageButton btn_back, btn_save;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.frag_form_cuenta);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.ib_save) {
            startActivity(new Intent(this, FormValidacionVisual.class));
        }
    }
}
